                      ...
                      {m.role === 'user' ? (
                          ...
                          <div className="prose prose-sm dark:prose-invert max-w-none prose-p:leading-relaxed prose-pre:bg-secondary prose-pre:border prose-pre:border-border">
                              <ReactMarkdown components={{
                                  ul: ({...props}) => <ul className="list-disc list-outside ml-4 mt-2 space-y-1 text-foreground" {...props} />,
                                  ol: ({...props}) => <ol className="list-decimal list-outside ml-4 mt-2 space-y-1 text-foreground" {...props} />,
                                  strong: ({...props}) => <strong className="font-bold text-primary bg-primary/10 px-1 rounded" {...props} />,
                                  a: ({...props}) => (
                                      <a 
