...
export function Footer() {
  ...
  return (
    <footer className="border-t border-border/40 bg-background py-10 relative overflow-hidden text-sm">
      <div className="container mx-auto px-6">
        <div className="grid grid-cols-1 md:grid-cols-12 gap-8 md:gap-12 items-start">
          ...
          <div className="md:col-span-3 md:col-start-7 space-y-4">
            <h3 className="font-bold text-foreground text-[10px] uppercase tracking-widest opacity-40">Navegación</h3>
            <ul className="space-y-2 text-xs font-medium">
              ...
              <li><Link href="/blog" className="text-muted-foreground hover:text-primary transition-colors">Blog de Ingeniería</Link></li>
            </ul>
          </div>

          {/* COL 3: CONTACTO (4 columnas) */}
          <div className="md:col-span-4 md:col-start-10 space-y-4">
            <h3 className="font-bold text-foreground text-[10px] uppercase tracking-widest opacity-40">Contacto</h3>
            <ul className="space-y-3 text-xs">
              <li>
                <a href="mailto:jososo1396@gmail.com" className="text-muted-foreground hover:text-primary flex items-center gap-3 transition-colors">
                  <Mail className="w-4 h-4 text-primary/80" /> 
                  <span className="truncate">jososo1396@gmail.com</span>
                </a>
              </li>
              <li>
                <a href="https://wa.me/51923384303" className="text-muted-foreground hover:text-primary flex items-center gap-3 transition-colors">
            ...
            <div className="pt-2 flex gap-4 text-[10px] opacity-60">
